(function() {
  ...
  // *** CUSTOM ***
  // The code below almost certainly does not belong here.

  d3.div = {};
  d3.div.axis = function() {
    ...
    function axis(g) {
      g.each(function() {
        ...
        var tick = g.selectAll("g").data(ticks, String),
          tickEnter = tick.enter().insert("div", "path").attr("class", "tick-group").style("opacity", 1e-6),
        ...
        path.enter().append("div").attr("class", "domain path");
        tickEnter.append("div").attr("class", "path");
        tickEnter.append("span").attr("class", "text");

        var lineEnter = tickEnter.select(".path"),
          lineUpdate = tickUpdate.select(".path"),
        ...
        case "bottom":
          {
            tickTransform = d3_svg_axisX;
            subtickEnter.attr("style", "height: " + tickMinorSize + "px");
            subtickUpdate.attr("style", "height: " + tickMinorSize + "px");
            lineEnter.attr("style", "height: " + tickMajorSize + "px");
            textEnter.attr("style", "top: " + (Math.max(tickMajorSize, 0) + tickPadding) + "px");
            lineUpdate.attr("style", "height: " + tickMajorSize + "px");
            textUpdate.attr("style", "left: 0px; top: " + (Math.max(tickMajorSize, 0) + tickPadding) + "px");
            text.attr("style", "padding-top: .71em; text-anchor: middle");
            pathUpdate.attr("style", "left: " + range[0] + "px; width: " + range[1] + "px;");
            // pathUpdate.attr("d", "M" + range[0] + "," + tickEndSize + "V0H" + range[1] + "V" + tickEndSize);
            break;
          }
        case "top":
